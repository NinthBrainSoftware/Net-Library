    ...
    <asp:Panel ID="listwrapper" runat="server">
        <div class="formee">
            <div class="grid-3-12">
                ...
                <asp:TextBox ID="nbsIdSearch" runat="server" CssClass="formee-medium"></asp:TextBox>
            ...
            <div class="grid-3-12 clear">
                ...
                <asp:TextBox ID="uniqueIdentifierSearch" runat="server" CssClass="formee-medium"></asp:TextBox>
    ...
    <asp:Panel ID="detailwrapper" runat="server" Visible="false">
        <div class="formee">
            ...
            <div class="grid-12-12">
                <asp:Button ID="btnBackToList" runat="server" CssClass="left" Text="Refine Search"
